-- Sistema Campagne Email Professionale
-- Esegui questo in Supabase SQL Editor

-- Tabella principale campagne
CREATE TABLE IF NOT EXISTS email_campaigns (
  ...
  -- Owner (se users e businesses usano bigint, cambia questi)
  created_by UUID,
  business_id UUID
);

-- Tabella per tracking dettagliato campagne (collega a email_logs)
...
-- Policy examples (da personalizzare in base al tuo sistema auth)
-- CREATE POLICY "Users can view own business campaigns" ON email_campaigns
