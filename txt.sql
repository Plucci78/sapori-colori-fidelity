...
-- PASSO 0: Avvia una transazione. Se qualcosa va storto, tutto verrà annullato.
BEGIN;
...
-- PASSO 4: Se tutti i comandi precedenti hanno avuto successo, rendi le modifiche permanenti.
COMMIT;

-- PASSO 5: Messaggio di conferma.
